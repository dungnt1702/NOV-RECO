...
from .test_view import simple_user_update_view, test_user_update_view
from .views import (
    debug_current_user,
...
urlpatterns = [
    ...
    path(
        "list/department_id/<int:department_id>/",
        user_list_view,
    ...
    path(
        "departments/office_id/<int:office_id>/",
        department_list_view,
        name="department_list_by_office",
    ),
    path("departments/create/", department_create_view, name="department_create"),
    path(
        "departments/update/<int:dept_id>/",
        department_update_view,
        name="department_update",
    ),
    path(
        "departments/delete/<int:dept_id>/",
        department_delete_view,
