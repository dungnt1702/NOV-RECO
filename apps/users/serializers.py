...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'role_display', 'department', 'department_name', 'phone',
            'avatar', 'date_of_birth', 'gender', 'address', 'emergency_contact',
            'emergency_phone', 'position', 'hire_date', 'salary', 'work_schedule',
            'skills', 'notes', 'is_active_employee', 'is_active', 'date_joined'
        ]
...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'role', 'department', 'phone', 'date_of_birth', 'gender', 'address',
...
class UserUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'username', 'first_name', 'last_name', 'email', 'password', 'password_confirm',
            'role', 'department', 'phone', 'avatar', 'date_of_birth', 'gender', 'address',
            'emergency_contact', 'emergency_phone', 'position', 'hire_date',
            'salary', 'work_schedule', 'skills', 'notes', 'is_active_employee', 'is_active'
        ]
