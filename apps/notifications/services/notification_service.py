    ...
    def send_approval_notification(absence_request, approver):
        ...
        notification = Notification.objects.create(
            ...
            data={
                ...
                'department': absence_request.user.department.full_name if absence_request.user.department else 'N/A'
            },
    ...
    def send_completion_notification(absence_request):
        ...
        notification = Notification.objects.create(
            ...
            data={
                ...
                'start_date': absence_request.start_date.isoformat(),
                'end_date': absence_request.end_date.isoformat(),
                'approved_by': absence_request.approved_by.get_full_name() if absence_request.approved_by else 'Hệ thống'
            }
        )
    ...
    def send_rejection_notification(absence_request):
        ...
        notification = Notification.objects.create(
            ...
            data={
                ...
                'rejected_by': absence_request.approved_by.get_full_name() if absence_request.approved_by else 'Hệ thống'
            }
        )
