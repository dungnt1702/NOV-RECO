...
class ModuleSettings(models.Model):
    ...
    module_name = models.CharField(
        max_length=50, choices=MODULE_CHOICES, unique=True, help_text="Tên module"
    )

    is_enabled = models.BooleanField(
        default=True, help_text="Module có được bật hay không"
    )

    display_name = models.CharField(max_length=100, help_text="Tên hiển thị của module")
    ...
    def get_disabled_modules(cls):
        ...
        return cls.objects.filter(is_enabled=False).values_list(
