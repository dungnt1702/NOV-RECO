...
from . import api_views, api_views_workflow, views
...
urlpatterns = [
    ...
    path(
        "workflow/update/<int:workflow_id>/",
        views.workflow_update_view,
    ...
    path(
        "api/approve/<int:absence_id>/",
        api_views.approve_request_api,
        name="api_approve",
    ),
    path(
        "api/status/<int:absence_id>/", api_views.workflow_status_api, name="api_status"
    ),
    # Workflow API
    path("api/workflow/", api_views_workflow.workflow_api, name="api_workflow"),
    path(
        "api/workflow/<int:workflow_id>/",
        api_views_workflow.workflow_detail_api,
        name="api_workflow_detail",
    ),
]
