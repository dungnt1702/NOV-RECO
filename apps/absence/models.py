...
class AbsenceType(models.Model):
    ...
    max_days_per_year = models.IntegerField(null=True, blank=True, help_text="Số ngày tối đa/năm")
...
class ApprovalWorkflow(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE, help_text="Phòng ban")
    absence_type = models.ForeignKey(AbsenceType, on_delete=models.CASCADE, help_text="Loại vắng mặt")
...
class AbsenceRequest(models.Model):
    ...
    absence_type = models.ForeignKey(AbsenceType, on_delete=models.CASCADE, help_text="Loại vắng mặt")
    workflow = models.ForeignKey(ApprovalWorkflow, on_delete=models.CASCADE, help_text="Workflow")
    ...
    total_days = models.DecimalField(max_digits=4, decimal_places=1, help_text="Tổng số ngày")
    reason = models.TextField(help_text="Lý do")
    attachment = models.FileField(upload_to='absence_attachments/', null=True, blank=True, help_text="File đính kèm")
    ...
    approval_level = models.CharField(max_length=50, default='department_manager', help_text="Cấp phê duyệt hiện tại")
    
    # Phê duyệt cuối cùng
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending', help_text="Trạng thái")
    ...
    approved_at = models.DateTimeField(null=True, blank=True, help_text="Thời gian phê duyệt")
...
class ApprovalHistory(models.Model):
    ...
    absence_request = models.ForeignKey(AbsenceRequest, on_delete=models.CASCADE, help_text="Đơn vắng mặt")
    approver = models.ForeignKey(User, on_delete=models.CASCADE, help_text="Người phê duyệt")
    action = models.CharField(max_length=20, choices=ACTION_CHOICES, help_text="Hành động")
