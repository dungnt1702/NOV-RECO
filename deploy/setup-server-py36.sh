...
echo ""
echo -e "${BLUE}🌐 URLs:${NC}"
echo -e "${GREEN}   Website: https://checkin.taylaibui.vn${NC}"
echo -e "${GREEN}   Admin:   https://checkin.taylaibui.vn/admin${NC}"
echo -e "${BLUE}   Internal: http://localhost:$PORT (for development)${NC}"
echo ""
