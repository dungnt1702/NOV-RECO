...
class IssueFixer:
    ...
    def log_fix(self, fix_name, success, message=""):
        ...
        self.fixes_applied.append(
            {"fix": fix_name, "success": success, "message": message}
        )
    ...
    def fix_static_files(self):
        ...
        try:
            ...
            self.log_fix(
                "Collect Static Files", True, "Static files collected successfully"
            )
    ...
    def fix_media_files(self):
        ...
        try:
            ...
            self.log_fix(
                "Media Directories", True, "Media directories created successfully"
            )
