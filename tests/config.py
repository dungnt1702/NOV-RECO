...
TEST_DATA = {
    ...
    'AREAS': {
        'COUNT': 7,
        'LOCATIONS': [
            {'name': 'Văn phòng chính', 'lat': 10.762622, 'lng': 106.660172, 'radius': 50},
            {'name': 'Chi nhánh Quận 1', 'lat': 10.7769, 'lng': 106.7009, 'radius': 100},
            {'name': 'Chi nhánh Quận 7', 'lat': 10.7329, 'lng': 106.7229, 'radius': 80},
            {'name': 'Kho hàng Bình Dương', 'lat': 10.9804, 'lng': 106.6519, 'radius': 200},
            {'name': 'Showroom Đồng Nai', 'lat': 10.9447, 'lng': 106.8243, 'radius': 150},
            {'name': 'Văn phòng đại diện Hà Nội', 'lat': 21.0285, 'lng': 105.8542, 'radius': 120},
            {'name': 'Trung tâm đào tạo', 'lat': 10.7626, 'lng': 106.6601, 'radius': 60},
        ]
    },
    'CHECKINS': {
        'COUNT': 300,
...
WATCH_SETTINGS = {
    ...
    'TIMEOUT': 120,  # seconds
    'IGNORED_DIRS': {'.git', '__pycache__', 'node_modules', '.pytest_cache', 'venv', 'static', 'media'},
