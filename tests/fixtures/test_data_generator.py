...
class TestDataGenerator:
    ...
    def generate_departments(self):
        ...
        department_data = [
            ...
            {'name': 'Phòng Kinh doanh', 'description': 'Kinh doanh và phát triển thị trường'},
    ...
    def generate_users(self):
        ...
        # Admin users
        admin_data = [
            {'username': 'admin', 'email': 'admin@nov-reco.com', 'first_name': 'Admin', 'last_name': 'System', 'role': UserRole.ADMIN},
            {'username': 'superadmin', 'email': 'superadmin@nov-reco.com', 'first_name': 'Super', 'last_name': 'Admin', 'role': UserRole.ADMIN},
        ]
        
        # Manager users
        manager_data = [
            {'username': 'manager_it', 'email': 'manager.it@nov-reco.com', 'first_name': 'Nguyễn', 'last_name': 'Văn IT', 'role': UserRole.MANAGER},
            {'username': 'manager_hr', 'email': 'manager.hr@nov-reco.com', 'first_name': 'Trần', 'last_name': 'Thị HR', 'role': UserRole.MANAGER},
            {'username': 'manager_sales', 'email': 'manager.sales@nov-reco.com', 'first_name': 'Lê', 'last_name': 'Văn Sales', 'role': UserRole.MANAGER},
        ]
        
        # Employee users
        employee_data = [
            {'username': 'emp001', 'email': 'emp001@nov-reco.com', 'first_name': 'Nguyễn', 'last_name': 'Văn A', 'role': UserRole.EMPLOYEE},
            {'username': 'emp002', 'email': 'emp002@nov-reco.com', 'first_name': 'Trần', 'last_name': 'Thị B', 'role': UserRole.EMPLOYEE},
            {'username': 'emp003', 'email': 'emp003@nov-reco.com', 'first_name': 'Lê', 'last_name': 'Văn C', 'role': UserRole.EMPLOYEE},
            {'username': 'emp004', 'email': 'emp004@nov-reco.com', 'first_name': 'Phạm', 'last_name': 'Thị D', 'role': UserRole.EMPLOYEE},
            {'username': 'emp005', 'email': 'emp005@nov-reco.com', 'first_name': 'Hoàng', 'last_name': 'Văn E', 'role': UserRole.EMPLOYEE},
            {'username': 'emp006', 'email': 'emp006@nov-reco.com', 'first_name': 'Vũ', 'last_name': 'Thị F', 'role': UserRole.EMPLOYEE},
            {'username': 'emp007', 'email': 'emp007@nov-reco.com', 'first_name': 'Đặng', 'last_name': 'Văn G', 'role': UserRole.EMPLOYEE},
            {'username': 'emp008', 'email': 'emp008@nov-reco.com', 'first_name': 'Bùi', 'last_name': 'Thị H', 'role': UserRole.EMPLOYEE},
            {'username': 'emp009', 'email': 'emp009@nov-reco.com', 'first_name': 'Đỗ', 'last_name': 'Văn I', 'role': UserRole.EMPLOYEE},
            {'username': 'emp010', 'email': 'emp010@nov-reco.com', 'first_name': 'Hồ', 'last_name': 'Thị J', 'role': UserRole.EMPLOYEE},
        ]
