...
class DashboardModelTest(TestBase):
...
class DashboardViewsTest(TestBase):
...
class DashboardFormsTest(TestBase):
...
class DashboardSerializersTest(TestBase):
    """Test dashboard serializers"""
